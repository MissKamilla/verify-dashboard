...
export function AuthLayout({ children, heroVariant }: AuthLayoutProps) {
  return (
    <main className="min-h-screen bg-white min-[1440px]:grid min-[1440px]:grid-cols-[661px_779px] min-[1440px]:justify-center">
      <section className="flex min-h-screen flex-col min-[1440px]:block">
        ...
        <p className="mt-auto px-5 pb-[53px] pt-[53px] text-center text-sm font-medium leading-6 text-text-main min-[1440px]:hidden">
